...
namespace QuanLyBanHang
{
    public partial class frmThongKeDoanhThuThang : Form
    {
        ...
        {
            string sql = "Select MaHDBan, NgayBan, TongTien from tblHDBan where 1=1";
            if(txtThang.Text == "")
            {
            ...
            sql += " AND MONTH(NgayBan) like N'%" + txtThang.Text + "%'";
            sql += " AND YEAR(NgayBan) like N'%" + txtNam.Text + "%'";
            ...
            string doanhthu = "Select SUM(TongTien) from tblHDBan where 1=1";
            doanhthu += " AND MONTH(NgayBan) like N'%" + txtThang.Text + "%'";
            doanhthu += " AND YEAR(NgayBan) like N'%" + txtNam.Text + "%'";
        ...
        private void dgvThongKe_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                mahd = dgvThongKe.CurrentRow.Cells["MaHDBan"].Value.ToString();
