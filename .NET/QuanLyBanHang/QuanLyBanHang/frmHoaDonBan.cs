...
namespace QuanLyBanHang
{
    public partial class frmHoaDonBan : Form
    {
        ...
        private void frmHoaDonBan_Load(object sender, EventArgs e)
        {
            ...
            Functions.FillCombo("SELECT MaHDBan FROM tblHDBan", cboMaHoaDon, "MaHDBan", "MaHDBan");
        ...
        private void LoadDataGridView()
        {
            ...
            dgvHoaDonBan.Columns[5].Width = 90;
        ...
        private void btnLuuHoaDon_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO tblHDBan(MaHDBan, NgayBan, MaNhanVien, MaKhach, TongTien) VALUES (N'" + txtMaHDBan.Text.Trim() + "','" +
                        dtpNgayBan.Value + "',N'" + txtMaNhanVien.Text + "',N'" +
            ...
            SLcon = sl - Double.Parse(txtSoLuong.Text);
            sql = "UPDATE tblHang SET SoLuong =" + SLcon + " WHERE MaHang= N'" + cboMaHang.SelectedValue + "'";
            Functions.RunSQL(sql);
            // Cập nhật lại tổng tiền cho hóa đơn bán
            tong = Double.Parse(Functions.GetFieldValues("SELECT TongTien FROM tblHDBan WHERE MaHDBan = N'" + txtMaHDBan.Text + "'"));
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Niên luận cơ sở ngành";
        ...
        private void cboMaKhach_DropDown(object sender, EventArgs e)
        {
            Functions.FillCombo("SELECT MaHDBan FROM tblHDBan", cboMaHoaDon, "MaHDBan", "MaHDBan");
            cboMaHoaDon.SelectedIndex = -1;
        } 
        ...
        {
            cboMaHang.Text = dgvHoaDonBan.CurrentRow.Cells["MaHang"].Value.ToString();
            txtTenHang.Text = dgvHoaDonBan.CurrentRow.Cells["TenHang"].Value.ToString();
